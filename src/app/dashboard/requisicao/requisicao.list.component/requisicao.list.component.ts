...
import { RequisicaoOverviewComponent } from '../requisicao.overview.component/requisicao.overview.component';
...
@Component({
  ...
  templateUrl: './templates/requisicao.list.component.html',
  styleUrls: ['./templates/requisicao.list.component.scss']
})
export class RequisicaoListComponent {
  srcNumero: string;
  ...
  constructor(private requisicaoOverviewComponent: RequisicaoOverviewComponent, 
